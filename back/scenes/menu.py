...
class Scene:
    def __init__(self, args):
        ...
        self.buttons = {
            ...
            'save': c.Button((self.args.size[0] // 2, 400), (600, 80), 'Load Saved Game',
                                     font=('src', 'timesnewroman.ttf', 25), align=(1, 1), background=(210, 210, 210)),
            'replay': c.Button((self.args.size[0] // 2, 500), (600, 80), 'Replay',
                             font=('src', 'timesnewroman.ttf', 25), align=(1, 1), background=(210, 210, 210)),
            'quit': c.Button((self.args.size[0] // 2, 600), (600, 80), 'Exit',
                                     font=('src', 'timesnewroman.ttf', 25), align=(1, 1), background=(210, 210, 210)),
        }
    ...
    def show(self, ui):
        ...
        ui.show_texts((self.args.size[0] // 2, 150), [["CUT", (255, 0, 0)], [" & ", (0, 0, 0)], ["SLICE", (0, 0, 255)]],
                      font=('src', 'cambria.ttf', 120), align=(1, 1))
        for name in self.buttons:
